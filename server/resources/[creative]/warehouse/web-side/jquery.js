	...
	$('.empty').droppable({
		...
		drop: function(event,ui){
			...
			if (origin === "invLeft" && tInv === "invLeft"){
				...
				$.post("http://warehouse/takeItem",JSON.stringify({
					item: itemData.key,
					slot: itemData.slot,
					target: target,
					amount: parseInt(amount)
				...
				$.post("http://warehouse/storeItem",JSON.stringify({
					item: itemData.key,
					slot: itemData.slot,
					target: target,
					amount: parseInt(amount)
				...
				$.post("http://warehouse/updateWarehouse",JSON.stringify({
					item: itemData.key,
					slot: itemData.slot,
					target: target,
					amount: parseInt(amount)
...
const requestWarehouse = () => {
	$.post("http://warehouse/requestWarehouse",JSON.stringify({}),(data) => {
